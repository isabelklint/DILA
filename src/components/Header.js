    ...
    <header className="bg-white py-4 text-[#1A2534] shadow-md">
      <nav className="flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-row flex-wrap justify-center md:flex-row items-center md:space-x-4 text-uppercase">
          ...
          <Link to="/instructors" className="text-[#1A2534] hover:text-blue-500 mb-2 md:mb-0 px-2">{t('instructors').toUpperCase()}</Link>
          <Link to="/history" className="text-[#1A2534] hover:text-blue-500 mb-2 md:mb-0 px-2">{t('about').toUpperCase()}</Link>
          <Link to="/alumni" className="text-[#1A2534] hover:text-blue-500 mb-2 md:mb-0 px-2">{t('alumni').toUpperCase()}</Link>
          <Link to="/contact" className="text-[#1A2534] hover:text-blue-500 mb-2 md:mb-0 px-2">{t('contact.title').toUpperCase()}</Link>
          <LanguageSwitcher />
        </div>
      </nav>
    </header>
